    ...
    <div className="bg-background min-h-screen text-foreground">
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        ...
        <main className="flex flex-col items-center justify-center py-20 sm:py-32 text-center">
          <Sparkles className="w-16 h-16 text-muted-foreground opacity-40 mb-6" />
          ...
          <p className="text-muted-foreground text-base mb-8 max-w-md">
            We couldn&apos;t find this animated title in our database. It may have been removed or the URL might be incorrect.
          </p>
          <Link href="/animation">
