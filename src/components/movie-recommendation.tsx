    ...
    <section className="py-8 md:py-12">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <p className="text-[11px] tracking-widest uppercase text-muted-foreground mb-3">Genres</p>
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <p className="text-[11px] tracking-widest uppercase text-muted-foreground mb-3">Mood</p>
                    <div className="flex flex-wrap gap-2">
                      {moods.map((mood) => {
              ...
              <div className="flex items-center gap-3">
                ...
                {history.length > 0 && (
                  <Button
                    ...
                    className="rounded-full px-4 py-3 h-auto text-sm"
                  >
        ...
        <div className="min-h-[320px]">
          {/* History panel */}
          {showHistory && (
            <div className="bg-[hsl(var(--rec-surface))] rounded-[2rem] p-6 md:p-8">
          ...
          {isLoading && !recommendation && !showHistory && (
            <div className="bg-[hsl(var(--rec-surface))] rounded-[2rem] p-6 md:p-8 h-full flex flex-col items-center justify-center min-h-[320px]">
              ...
              <p className="text-[hsl(var(--rec-muted))] text-sm">Finding a great movie for you...</p>
            </div>
          )}
